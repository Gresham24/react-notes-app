...
import { Button, Input, Checkbox } from '../../../components/ui/index.js';
...
export const SignUp: React.FC<SignUpProps> = ({ onSignInClick }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log('Sign up submitted:', { fullName, email, password, confirmPassword, agreedToTerms });
  };
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
          <div className="mb-6 text-center">
            ...
            <p className="text-gray-600">Sign up to start taking notes</p>
          </div>
